...
class MessageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StoreMessage = channel.unary_unary(
                '/messages.MessageService/StoreMessage',
                request_serializer=protofile__pb2.MessageRequest.SerializeToString,
                response_deserializer=protofile__pb2.MessageResponse.FromString,
                _registered_method=True)
        self.GetMessages = channel.unary_unary(
                '/messages.MessageService/GetMessages',
                request_serializer=protofile__pb2.Empty.SerializeToString,
                response_deserializer=protofile__pb2.MessageList.FromString,
                _registered_method=True)
...
def add_MessageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StoreMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protofile__pb2.MessageRequest.FromString,
                    response_serializer=protofile__pb2.MessageResponse.SerializeToString,
            ),
            'GetMessages': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMessages,
                    request_deserializer=protofile__pb2.Empty.FromString,
                    response_serializer=protofile__pb2.MessageList.SerializeToString,
            ),
    }
...
class MessageService(object):
    ...
    def StoreMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/messages.MessageService/StoreMessage',
            protofile__pb2.MessageRequest.SerializeToString,
            protofile__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            protofile__pb2.MessageList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
